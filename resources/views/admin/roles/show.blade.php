...
@section('content')
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					{!! Form::open(array('route' => 'admin.permissions.store', 'method' => 'POST', 'class' => 'ui form')) !!}
	...
	<a href="{{ route('admin.roles.index') }}"><button class="ui red basic button">Back to roles</button></a>
	...
	<table class="ui celled striped table">
		...
		<tbody>
			...
			<tr>
				<td class="collapsing">
					<i class="user icon"></i>{{$permission->id}}
				</td>
				<td>{{$permission->display_name}}</td>
				<td class="right aligned collapsing">{{$permission->name}}</td>
			</tr>
			@endforeach
		</tbody>
	</table>
